...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppInstance.tarball'
        db.add_column('app_collection_appinstance', 'tarball',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppInstance.tarball'
        db.delete_column('app_collection_appinstance', 'tarball')
    ...
    models = {
        ...
        'app_collection.appinstance': {
            ...
            'tarball': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True'})
        },
        'auth.group': {
