...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('app_collection_app', 'setup_sql', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'App.remove_sql'
        db.add_column('app_collection_app', 'remove_sql', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 22, 13, 42, 58, 457756)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 3, 22, 13, 42, 58, 457278)'}),
